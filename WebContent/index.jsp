            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul class="iq-menu">
                     ...
                     <li class="active">
                        <a href="index.jsp" class="iq-waves-effect"><i class="ri-hospital-fill"></i><span>医生仪表板</span></a>
                     </li>                     
                     <li>
                        <a href="dashboard-1.jsp" class="iq-waves-effect"><i class="ri-home-8-fill"></i><span>医院仪表板 1 </span></a>
                     </li>
                     <li>
                        <a href="dashboard-2.jsp" class="iq-waves-effect"><i class="ri-briefcase-4-fill"></i><span>医院仪表板 2</span></a>
                     </li>
                     <li>
                        <a href="dashboard-3.jsp" class="iq-waves-effect"><i class="ri-group-fill"></i><span>病人仪表板 </span></a>
                     </li>
                    <li>
                        ...
                        <ul class="iq-submenu">
                           ...
                           <li><a href="add-doctor.jsp"><i class="ri-user-add-fill"></i> 添加部门</a></li>
                     ...
                     <li>
                        ...
                        <ul class="iq-submenu">
                           ...
                           <li><a href="add-doctor.jsp"><i class="ri-user-add-fill"></i> 添加医生</a></li>
                     ...
                     <li><a href="calendar.jsp" class="iq-waves-effect"><i class="ri-calendar-event-fill"></i><span>Calendar</span></a></li>
                    
                    <li><a href="chat.jsp" class="iq-waves-effect"><i class="ri-message-fill"></i><span>Chat</span></a></li>
                     ...
                     <li>
                        ...
                        <ul class="iq-submenu">
                           <li><a href="ui-colors.jsp"><i class="ri-font-color"></i>colors</a></li>
                           <li><a href="ui-typography.jsp"><i class="ri-text"></i>Typography</a></li>
                           <li><a href="ui-alerts.jsp"><i class="ri-alert-fill"></i>Alerts</a></li>
                           <li><a href="ui-badges.jsp"><i class="ri-building-3-fill"></i>Badges</a></li>
                           <li><a href="ui-breadcrumb.jsp"><i class="ri-guide-fill"></i>Breadcrumb</a></li>
                           <li><a href="ui-buttons.jsp"><i class="ri-checkbox-blank-fill"></i>Buttons</a></li>
                           <li><a href="ui-cards.jsp"><i class="ri-bank-card-fill"></i>Cards</a></li>
                           <li><a href="ui-carousel.jsp"><i class="ri-slideshow-4-fill"></i>Carousel</a></li>
                           <li><a href="ui-embed-video.jsp"><i class="ri-movie-fill"></i>Video</a></li>
                           <li><a href="ui-grid.jsp"><i class="ri-grid-fill"></i>Grid</a></li>
                           <li><a href="ui-images.jsp"><i class="ri-image-fill"></i>Images</a></li>
                           <li><a href="ui-list-group.jsp"><i class="ri-file-list-fill"></i>list Group</a></li>
                           <li><a href="ui-media-object.jsp"><i class="ri-camera-fill"></i>Media</a></li>
                           <li><a href="ui-modal.jsp"><i class="ri-checkbox-blank-fill"></i>Modal</a></li>
                           <li><a href="ui-notifications.jsp"><i class="ri-notification-3-fill"></i>Notifications</a></li>
                           <li><a href="ui-pagination.jsp"><i class="ri-more-fill"></i>Pagination</a></li>
                           <li><a href="ui-popovers.jsp"><i class="ri-folder-shield-fill"></i>Popovers</a></li>
                           <li><a href="ui-progressbars.jsp"><i class="ri-battery-low-fill"></i>Progressbars</a></li>
                           <li><a href="ui-tabs.jsp"><i class="ri-database-fill"></i>Tabs</a></li>
                           <li><a href="ui-tooltips.jsp"><i class="ri-record-mail-fill"></i>Tooltips</a></li>
                        </ul>
                     </li>
                     <li>
                        ...
                        <ul class="iq-submenu">
                           <li><a href="form-layout.jsp"><i class="ri-tablet-fill"></i>Form Elements</a></li>
                           <li><a href="form-validation.jsp"><i class="ri-device-fill"></i>Form Validation</a></li>
                           <li><a href="form-switch.jsp"><i class="ri-toggle-fill"></i>Form Switch</a></li>
                           <li><a href="form-chechbox.jsp"><i class="ri-chat-check-fill"></i>Form Checkbox</a></li>
                           <li><a href="form-radio.jsp"><i class="ri-radio-button-fill"></i>Form Radio</a></li>
                        </ul>
                     </li>
                     <li>
                        ...
                        <ul class="iq-submenu">
                           <li><a href="form-wizard.jsp"><i class="ri-anticlockwise-fill"></i>Simple Wizard</a></li>
                           <li><a href="form-wizard-validate.jsp"><i class="ri-anticlockwise-2-fill"></i>Validate Wizard</a></li>
                           <li><a href="form-wizard-vertical.jsp"><i class="ri-clockwise-fill"></i>Vertical Wizard</a></li>
                        </ul>
                     </li>
                     <li>
                        ...
                        <ul class="iq-submenu">
                           <li><a href="tables-basic.jsp"><i class="ri-table-fill"></i>Basic Tables</a></li>
                           <li><a href="data-table.jsp"><i class="ri-table-2"></i>Data Table</a></li>
                           <li><a href="table-editable.jsp"><i class="ri-archive-drawer-fill"></i>Editable Table</a></li>
                        </ul>
                     </li>
                     <li>
                        ...
                        <ul class="iq-submenu">
                           <li><a href="chart-morris.jsp"><i class="ri-file-chart-fill"></i>Morris Chart</a></li>
                           <li><a href="chart-high.jsp"><i class="ri-bar-chart-fill"></i>High Charts</a></li>
                           <li><a href="chart-am.jsp"><i class="ri-bar-chart-box-fill"></i>Am Charts</a></li>
                           <li><a href="chart-apex.jsp"><i class="ri-pie-chart-box-fill"></i>Apex Chart</a></li>
                        </ul>
                     </li>
                     <li>
                        ...
                        <ul class="iq-submenu">
                           <li><a href="icon-dripicons.jsp"><i class="ri-stack-fill"></i>Dripicons</a></li>
                           <li><a href="icon-fontawesome-5.jsp"><i class="ri-facebook-fill"></i>Font Awesome 5</a></li>
                           <li><a href="icon-lineawesome.jsp"><i class="ri-keynote-fill"></i>line Awesome</a></li>
                           <li><a href="icon-remixicon.jsp"><i class="ri-remixicon-fill"></i>Remixicon</a></li>
                     ...
                     <li>
                        ...
                        <ul class="iq-submenu">
                           <li><a href="sign-in.jsp"><i class="ri-login-box-fill"></i>Login</a></li>
                           <li><a href="sign-up.jsp"><i class="ri-logout-box-fill"></i>Register</a></li>
                           <li><a href="pages-recoverpw.jsp"><i class="ri-record-mail-fill"></i>Recover Password</a></li>
                           <li><a href="pages-confirm-mail.jsp"><i class="ri-chat-check-fill"></i>Confirm Mail</a></li>
                           <li><a href="pages-lock-screen.jsp"><i class="ri-file-lock-fill"></i>Lock Screen</a></li>
                        </ul>
                     </li>
                     <li>
                        ...
                        <ul class="iq-submenu">
                           <li><a href="pages-map.jsp"><i class="ri-google-fill"></i>Google Map</a></li>
                     ...
                     <li>
                        ...
                        <ul class="iq-submenu">
                           <li><a href="pages-timeline.jsp"><i class="ri-map-pin-time-fill"></i>Timeline</a></li>
                           <li><a href="pages-invoice.jsp"><i class="ri-question-answer-fill"></i>Invoice</a></li>
                           <li><a href="blank-page.jsp"><i class="ri-checkbox-blank-fill"></i>Blank Page</a></li>
                           <li><a href="pages-error.jsp"><i class="ri-error-warning-fill"></i>Error 404</a></li>
                           <li><a href="pages-error-500.jsp"><i class="ri-error-warning-fill"></i>Error 500</a></li>
                           <li><a href="pages-pricing.jsp"><i class="ri-price-tag-3-fill"></i>Pricing</a></li>
                           <li><a href="pages-pricing-one.jsp"><i class="ri-price-tag-2-fill"></i>Pricing 1</a></li>
                           <li><a href="pages-maintenance.jsp"><i class="ri-git-repository-commits-fill"></i>Maintenance</a></li>
                           <li><a href="pages-comingsoon.jsp"><i class="ri-run-fill"></i>Coming Soon</a></li>
                           <li><a href="pages-faq.jsp"><i class="ri-compasses-2-fill"></i>Faq</a></li>
                        </ul>
                     </li>
                  </ul>
               </nav>
